...
abline(v=seq(0, 90, by=5), col="lightgray")
abline(h=seq(0, 1, by=0.025), col="lightgray")
...
for (i in 1:length(unique(j24$tws))) {
  ...
  min_wind_angles = c(min_wind_angles, x_data_wind[min_ttm])
